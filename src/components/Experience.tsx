        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="shadow-elevated bg-gradient-card border-0">
            <CardHeader>
              <div className="flex items-start justify-between flex-wrap gap-4">
                <div className="flex items-center">
                  ...
                  <div>
                    <CardTitle className="text-2xl text-foreground">Industrial Intern</CardTitle>
                    <p className="text-xl text-primary font-semibold">UltraTech Cement</p>
                  </div>
                </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <h4 className="text-lg font-semibold text-foreground mb-3">Key Learning Areas:</h4>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-primary rounded-full mr-3"></div>
                      <span className="text-muted-foreground">Vertical Roller Mill (VRM) Operations</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-primary rounded-full mr-3"></div>
