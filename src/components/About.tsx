    ...
    <section id="about" className="py-20 bg-secondary/30">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl text-display text-center mb-12 text-foreground uppercase tracking-wide">About Me</h2>
            ...
            <Card className="shadow-card bg-gradient-card border-0">
              <CardContent className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl text-heading text-foreground uppercase tracking-wide">Education</h3>
                </div>
                <p className="text-muted-foreground mb-3">
                  <strong className="text-foreground">B.Tech Chemical Engineering</strong>
                </p>
                <p className="text-muted-foreground mb-2">SASTRA Deemed University</p>
            ...
            <Card className="shadow-card bg-gradient-card border-0">
              <CardContent className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl text-heading text-foreground uppercase tracking-wide">Focus Areas</h3>
                </div>
          ...
          <Card className="shadow-elevated bg-gradient-card border-0">
            <CardContent className="p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl text-heading text-foreground uppercase tracking-wide">My Journey</h3>
              </div>
